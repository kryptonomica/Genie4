...
namespace GenieClient.Forms
{
    public partial class FormMapperSettings : Form
    {
        ...
        public async void Recolor()
        {
            ...
            _ButtonSetTypeahead.BackColor = button.BgColor.ToDrawingColor();
            _ButtonSetTypeahead.ForeColor = button.FgColor.ToDrawingColor();
            _ButtonSetDragging.BackColor = button.BgColor.ToDrawingColor();
            _ButtonSetDragging.ForeColor = button.FgColor.ToDrawingColor();
            _ButtonSetUserWalk.BackColor = button.BgColor.ToDrawingColor();
            _ButtonSetUserWalk.ForeColor = button.FgColor.ToDrawingColor();
            _ButtonSetClasses.BackColor = button.BgColor.ToDrawingColor();
            _ButtonSetClasses.ForeColor = button.FgColor.ToDrawingColor();
            CheckedListVariables.BackColor = textbox.BgColor.ToDrawingColor();
            CheckedListVariables.ForeColor = textbox.FgColor.ToDrawingColor();
            ...
            _TextboxDragging.BackColor = textbox.BgColor.ToDrawingColor();
            _TextboxDragging.ForeColor = textbox.FgColor.ToDrawingColor();
            _TextboxTypeahead.BackColor = textbox.BgColor.ToDrawingColor();
            _TextboxTypeahead.ForeColor = textbox.FgColor.ToDrawingColor();
            _TextboxClass.BackColor = textbox.BgColor.ToDrawingColor();
            _TextboxClass.ForeColor =  textbox.FgColor.ToDrawingColor();
